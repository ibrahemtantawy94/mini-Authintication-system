...
<div class="conatiner">
	...
	<?php 
	 ...
	 ?>
	<form class="form-horizontal  col-lg-12 col-md-4 col-xs-12" action="../control/create.php" method="POST" autocomplete="off">
		...
		<div class="form-group">
  			<div class="col-md-4 col-md-offset-5">
    			<input type="submit" value="Create A Post" class="form-control btn btn-primary" name="submit">
